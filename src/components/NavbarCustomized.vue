...
<template>
    <nav id="navbar" class="fixed top-0 w-full z-50 bg-white border-gray-200 dark:bg-gray-900">
        <div class="w-[90%] mx-auto flex items-center justify-between p-4">
            <!-- Logo Section -->
            ...
            <div class="flex items-center space-x-8">
                <!-- Desktop Navigation -->
                <ul class="hidden md:flex space-x-8 font-medium ml-auto">
                        ...
                        <a :href="item.url" @click="handleNavClick(item)" class="inline-flex items-center space-x-2"
                            ...
                            <svg v-if="item.icon"
                                ...
                                <path v-if="item.icon === 'trophy'" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3. LEDs to be 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                ...
                <!-- Dark Mode Toggle -->
                <label class="switch md:ml-4 mb-1.5">
