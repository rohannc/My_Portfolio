    ...
    <div class="container mx-auto px-7 py-8">
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-2 bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col max-h-[500px]">
                <h2 class="text-3xl font-bold text-white mb-4">About Our Platform</h2>
                <p class="text-gray-300 text-lg flex-grow">
                    Welcome to our innovative platform, where we empower users to showcase their achievements and
                    connect with communities worldwide. Our mission is to provide a seamless experience for
                    professionals, students, and enthusiasts to highlight their accomplishments, share knowledge, and
                    network effectively. Whether you're celebrating a competition win, a career milestone, or a personal
                    project, our platform is designed to make your journey visible and impactful.
                </p>
                <div class="mt-auto flex justify-center gap-6 pt-6">
            ...
            <div class="col-span-1 bg-gray-800 rounded-xl shadow-lg p-6">
                <form class="max-w-md mx-auto" @submit="handleSubmit">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <textarea id="message" name="message" rows="4" v-model="formState.message"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    ...
                    <!-- Feedback Messages -->
                    <div v-if="formState.error" class="mt-4 text-red-500 text-center">
                        {{ formState.error }}
                    </div>
                    <div v-if="formState.success" class="mt-4 text-green-500 text-center">
                        {{ formState.success }}
                    </div>
                </form>
            </div>
